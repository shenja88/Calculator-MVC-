    ...
    <div class="row mb-5 mt-2">
        <div class="d-flex flex-wrap justify-content-lg-start bg-success p-2 text-dark bg-opacity-50 rounded">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <c:if test="${sessionScope.user != null}">
                    <li><a href="/calc" class="nav-link px-2 link-dark border border-3 border-dark rounded me-1 bg-success p-2 bg-opacity-75">Calculator</a></li>
                    <li><a href="/calc/history" class="nav-link px-2 link-dark border border-3 border-dark rounded me-1 bg-success p-2 bg-opacity-75">History</a></li>
                    <li class="nav-item"><a class="nav-link disabled text-dark" href="#" tabindex="-1" aria-disabled="true">Hello
